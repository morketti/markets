...
| 3 | Analytical Agents — Deterministic Scoring (3/5 plans, In Progress) | Four Python analyst modules emit structured signals per ticker (5th is Phase 4 POSE) | ANLY-01..04 | 5 | Phase 2 |
