...
- [x] 06-05-polish-responsive-PLAN.md — Wave 4: ErrorBoundary (schema-mismatch + 404 paths) + DateSelector reading data/_dates.json + mobile-responsive breakpoints + Playwright mobile-safari + mobile-chrome projects + full-flow E2E + visual taste-check (VIEW-12, VIEW-14, VIEW-15)
